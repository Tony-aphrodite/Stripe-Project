...
function voltikaNotifyTemplates(): array {
    ...
    return [
        ...
        // Sent when a CEDIS controller account is created. Shorter than
        // credenciales_punto — no Punto line, no delivery legal notice; focus
        // on inventory responsibilities and the admin panel URL.
        'credenciales_cedis' => [

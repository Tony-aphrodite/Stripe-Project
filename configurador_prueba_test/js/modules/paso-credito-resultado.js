...
var PasoCreditoResultado = {
    ...
    _renderNoViable: function(resultado) {
        ...
        // Responsive grid (customer brief 2026-04-27): on narrow mobile
        // (<=560px) collapse to a single column so the long SPEI / OXXO
        // subtitles ("Transferencia bancaria... 24 horas automáticamente")
        // have room. On tablet/desktop (>=560px) keep the 2x2 layout.
        // minmax(260px,1fr) lets cards auto-fit: <520px wide → 1 col,
        // ≥520px → 2 cols.

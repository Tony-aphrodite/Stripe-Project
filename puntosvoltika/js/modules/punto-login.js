window.PV_login = (function(){
  function render(){
    ...
    PVApp.render(
      '<div class="ad-login">'+
        '<div style="margin-bottom:24px;display:flex;justify-content:center;"><img src="../configurador/img/voltika_logo_h.svg" alt="Voltika" style="height:40px;width:auto;" onerror="this.style.display=\'none\'"></div>'+
        '<div class="ad-card">'+

...
var PasoCreditoEnganche = {
    ...
    render: function() {
        ...
        html += '<div style="font-size:15px;margin-bottom:10px;font-weight:700;display:flex;align-items:center;gap:8px;"><img src="' + (window.VK_BASE_PATH || '') + 'img/last/icon_09.png" style="width:28px;height:28px;object-fit:contain;"> <span><strong style="color:#00C851;">Forma m\u00e1s r\u00e1pida</strong> de asegurar tu Voltika</span></div>';

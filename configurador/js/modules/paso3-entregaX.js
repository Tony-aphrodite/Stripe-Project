...
var Paso3 = {
    ...
    _tagButton: function(tag) {
        ...
        return '<span style="display:inline-flex;align-items:center;gap:3px;font-size:12px;font-weight:600;padding:3px 5px;border-radius:5px;background:#EDF2F7;color:#1a3a5c;border:1px solid #D0D8E0;transform:scale(0.75);transform-origin:left center;">' +
            iconCircle + tag + '</span>';
    },
    ...
    _renderCertificadoCard: function(centro) {
        ...
        // Tags
        h += '<div style="display:flex;flex-wrap:wrap;gap:0;margin-bottom:14px;">';
        if (centro.tags && centro.tags.length) {

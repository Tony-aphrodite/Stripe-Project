...
var Paso3 = {
    ...
    _tagButton: function(tag) {
        ...
        var sym = symbols[tag] || '\u2022';
        var iconCircle = '<span style="display:inline-flex;align-items:center;justify-content:center;width:12px;height:12px;border-radius:50%;background:#1a3a5c;color:#fff;font-size:6px;flex-shrink:0;">' + sym + '</span>';
        return '<span style="display:inline-flex;align-items:center;gap:2px;font-size:9px;font-weight:600;padding:2px 4px;border-radius:4px;background:#EDF2F7;color:#1a3a5c;border:1px solid #D0D8E0;">' +
            iconCircle + tag + '</span>';
    },
    ...
    _renderCertificadoCard: function(centro) {
        ...
        // Tags
        h += '<div style="display:flex;flex-wrap:wrap;gap:3px;margin-bottom:14px;">';
        if (centro.tags && centro.tags.length) {

...
var Paso3 = {
    ...
    render: function() {
        ...
        html += '<div>';
        html += '<div style="font-weight:800;font-size:15px;">Quiero cotizar y activar el seguro con <img src="' + (window.VK_BASE_PATH || '') + 'img/Qualitas.png" alt="Qu\u00e1litas" style="height:22px;vertical-align:middle;margin:0 2px;"> desde la entrega</div>';

 ...
 *   https://voltika.mx/configurador/php/truora-diag-completo.php
 */
...
$selfUrl = ($_SERVER['HTTPS'] ?? '') === 'on'
    ? 'https://' . ($_SERVER['HTTP_HOST'] ?? 'voltika.mx') . '/configurador/'
    : 'http://' . ($_SERVER['HTTP_HOST'] ?? 'voltika.mx') . '/configurador/';
$selfHeaders = [];

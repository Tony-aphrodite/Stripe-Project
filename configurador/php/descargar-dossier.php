...
// recognized when downloading from configurador/.
    ...
    if ($adminOk) {
        ...
        if ($needsServerFix) {
            ...
            if (!$dirOk) {
                ...
                echo "mkdir -p /var/www/voltika.mx/configurador/dossiers\n";
                echo "chmod 0775 /var/www/voltika.mx/configurador/dossiers\n";
                echo "chown www-data:www-data /var/www/voltika.mx/configurador/dossiers\n";
            ...
            if (!$hasFpdf) {
                ...
                echo "ls -la /var/www/voltika.mx/configurador/php/vendor/fpdf/fpdf.php\n";
                echo "\n";
                echo "# Si no existe, descargar e instalar:\n";
                echo "cd /var/www/voltika.mx/configurador/php/vendor/\n";

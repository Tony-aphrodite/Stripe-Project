window.VK_documentos = (function(){
  ...
  var DOC_META_CONTADO = {
    ...
    manual: {
      icon: '<svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="#3b82f6" stroke-width="2"><path d="M4 19.5A2.5 2.5 0 016.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 014 19.5v-15A2.5 2.5 0 016.5 2z"/></svg>',
      label: 'Manual del usuario',
      desc: 'Guia rapida para el cuidado de tu Voltika.',
      size: 'PDF - 3.5 MB',
      badge: 'DISPONIBLE',
      badgeColor: 'green',
      available: true
  ...
  function renderContado(){
    ...
    var keys = ['confirmacion','factura','carta_factura','contrato_cv','manual'];

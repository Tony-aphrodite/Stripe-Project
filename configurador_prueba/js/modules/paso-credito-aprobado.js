...
var PasoCreditoAprobado = {
    ...
    render: function() {
        ...
        html += '<img src="' + (window.VK_BASE_PATH || '') + 'img/Archivo 4/last_elements-06.png" alt="Moto aprobada" style="width:280px;max-width:90%;height:auto;margin:0 auto;display:block;">';
        html += '</div>';

...
<div id="adApp" class="ad-app">
  <nav id="adSidebar" class="ad-sidebar" style="display:none">
    ...
    <div class="ad-nav">
      ...
      <!-- Cobranza: dollar sign with clock -->
      ...
      <!-- Puntos Voltika: map pin -->
      <button data-route="puntos"><span><svg viewBox="0 0 24 24"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></span> Puntos Voltika</button>
      ...
      <button data-route="documentos"><span><svg viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg></span> Documentos</button>
      <!-- Analitica: bar chart trending -->
      ...
      <!-- Notificaciones: send/paper plane -->
      ...
      <!-- Rendimiento Puntos: activity/pulse -->

...
<div id="adApp" class="ad-app">
  <nav id="adSidebar" class="ad-sidebar" style="display:none">
    ...
    <div class="ad-nav">
      ...
      <!-- Customer brief 2026-05-12 (Óscar, 10th round): "There's other
           purchase operations without signed contract" — systemic audit
      ...
      <button data-route="pagares"><span><svg viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="9" y1="13" x2="15" y2="13"/><line x1="9" y1="17" x2="15" y2="17"/></svg></span> Pagarés</button>
      <button data-route="creditosEntregados"><span><svg viewBox="0 0 24 24"><rect x="1" y="4" width="22" height="16" rx="2"/><line x1="1" y1="10" x2="23" y2="10"/><line x1="6" y1="16" x2="10" y2="16"/></svg></span> Créditos entregados</button>
      <button data-route="cuentasCredito"><span><svg viewBox="0 0 24 24"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/><line x1="8" y1="10" x2="16" y2="10"/><line x1="8" y1="14" x2="13" y2="14"/></svg></span> Cuentas de crédito</button>
...
<script src="<?= $asset('js/modules/admin-pagares.js') ?>"></script>

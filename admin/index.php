...
<div id="adApp" class="ad-app">
  <nav id="adSidebar" class="ad-sidebar" style="display:none">
    ...
    <div class="ad-nav">
      ...
      <button data-route="ventas"><span><img src="../configurador_prueba/img/asesor_icon.jpg" alt=""></span> Ventas</button>
      ...
      <button data-route="pagos"><span><img src="../configurador_prueba/img/credito_voltika_logo.svg" alt=""></span> Pagos</button>
      <button data-route="puntos"><span><img src="../configurador_prueba/img/mexico_map.svg" alt=""></span> Puntos Voltika</button>
      <button data-route="checklists"><span><img src="../configurador_prueba/img/garantia.png" alt=""></span> Checklists</button>
